...
typedef enum QUIC_ALLOWED_CIPHER_SUITE_FLAGS {
    ...
    QUIC_ALLOWED_CIPHER_SUITE_ROCCA_S_SHA512            = 0x8,
...
typedef enum QUIC_CIPHER_ALGORITHM {
    ...
    QUIC_CIPHER_ALGORITHM_ROCCA_S     = 0x6614,
...
typedef enum QUIC_HASH_ALGORITHM {
    ...
    QUIC_HASH_ALGORITHM_SHA_512     = 0x800E,
} QUIC_HASH_ALGORITHM;
...
typedef enum QUIC_CIPHER_SUITE {
    ...
    QUIC_CIPHER_SUITE_TLS_ROCCA_S_SHA512            = 0x1306,
} QUIC_CIPHER_SUITE;
